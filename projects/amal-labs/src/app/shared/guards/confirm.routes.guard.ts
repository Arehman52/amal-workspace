...
import { AmalCustomSharedService } from '../services/AmalCustomShared.service';
import { ALERT_CONFIG, UN_SAVED_CHANGES } from '../_configs/shared.constants';
...
export class ConfirmRouteGuard implements CanDeactivate<CanComponentDeactivate> {
    constructor(
      private sharedService: AmalCustomSharedService
      ) { }
